...
var RCTRealtimeMessaging = require('RCTRealtimeMessagingIOS');
...
class MessagingScreen extends Component {
  ...
  componentDidMount(){
    // TODO setup push notifications, see http://react-components.com/component/react-native-realtimemessaging-ios
    // RCTRealtimeMessagingIOS.RTPushNotificationListener(this._onNotification);
  }
...
module.exports = MessagingScreen;
